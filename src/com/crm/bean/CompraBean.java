...
public class CompraBean {
	...
	public void guardarCompra(){
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "", "Se guardo la compra con c�digo " + id + " y se actualiz� el invertario"));
	}
